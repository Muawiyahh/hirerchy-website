      ...
      <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {features.map((f, i) => (
          <Reveal as="div" key={f.title} delay={(i % 3) * 80}>
            <div className="h-full rounded-card border border-border bg-surface/60 p-6 transition-all hover:-translate-y-1 hover:border-accent/40">
              <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-accent/12 text-accent ring-1 ring-accent/25">
                <Icon name={f.icon} />
              </div>
