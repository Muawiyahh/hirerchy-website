      ...
      <div className="mx-auto w-full max-w-6xl px-5 py-9 sm:px-8">
        <div className="grid gap-7 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-3 text-sm leading-relaxed text-white/60">{referral.body}</p>
          </div>
        </div>

        <div className="mt-8 flex flex-col items-start justify-between gap-3 border-t border-white/10 pt-5 text-sm text-white/50 sm:flex-row sm:items-center">
